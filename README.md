...
- Card persistence is implemented as an internal backend foundation only; see [`docs/card-persistence.md`](docs/card-persistence.md). No card HTTP routes or anonymous lookup are exposed yet.
